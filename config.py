...
V3_SOFT_STOP_LOSS = 0.03        # 阴跌止损3%
V3_TAKE_PROFIT = 0.05           # 主板/创业板固定止盈5%（保留兼容，已被移动止盈替代）
V3_TRAILING_ACTIVATE = 0.03     # 主板/创业板：浮盈超3%后激活移动止盈
V3_TRAILING_STOP = 0.02         # 主板/创业板：从最高价回撤2%触发卖出
...
V3_STAR_HARD_STOP_LOSS = 0.05   # 科创板硬止损5%
V3_STAR_SOFT_STOP_LOSS = 0.03   # 科创板阴跌止损3%
